// import { AfterRoutesInit, Constant, Injectable } from "@tsed/common";
// import { TypeORMService } from "@tsed/typeorm";
// import { Connection, Repository } from "typeorm";
//
// @Injectable()
// export class ORMService implements AfterRoutesInit {
//   @Constant("defaultConnection", "default")
...
//
//   $afterRoutesInit() {
//     this.connection = this.ormService.get(this.defaultConnection)!; // get connection by name
//   }
//
